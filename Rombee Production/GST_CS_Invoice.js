    ...
    function(currentRecord, record, search, runtime, log) {
        ...
        function fieldChanged(scriptContext) {
            ...
            if (getIndiaSubsidiary && (getIndiaSubsidiary == subsidiary)) {
               ...
               // alert(" BillingAddress:- " + isBillingAddress);

                //Shipping Address ...
                if (scriptContext.fieldId == "billaddresslist" && (isBillingAddress == false || isBillingAddress == 'false')) {
                    var inter = 2;
                    var intra = 1;
                    ...
                    var shippingAddress = Number(currentRecordObj.getValue({
                        fieldId: 'shipaddresslist' //ship address
                    }));
                ...
                //Billing Address...
                    ...
                    if (isBillingAddress == true) {
                        ...
                        var billingAddress = Number(currentRecordObj.getValue({
                            fieldId: 'billaddresslist' // 'shipaddresslist' //bill addr
                        }));
                        ...
                        var addressDetailsObject = getGstOnBillingAddress(customerRecord, shippingAddress);
                        var state = addressDetailsObject.state;
                ...
                //Billing Address...
                else if (scriptContext.fieldId == "shipaddresslist" && (isBillingAddress == true || isBillingAddress == 'true')) {
                   // alert("Bill addr ship");
                    var inter = 2;
                    var intra = 1;
        ...
        //If Billing Address is checked then get billing Address ...
